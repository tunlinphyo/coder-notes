...
The PageDialog custom element extends the [MiniEl](/html/miniel) class and creates a dialog element with a swipe-to-close function for mobile web apps.
...
```ts
const categoriesPage = document.querySelector<PageDialog>('#categoriesPage')
...
```ts
export class PageDialog extends MiniEl {
